...
const Home = () => {
  ...
  const testimonials = [
    ...
    { id: 5, name: "Sanjana Rai", image: customerImg5, text: "From conceptualization to publication, Quantive Research provided comprehensive support that made my academic journey smoother. Their expertise in methodology design was particularly helpful." },
    ...
    { id: 6, name: "Ritesh Waghchaure", image: customerImg6, text: "The team at Quantive Research demonstrated exceptional professionalism and subject matter expertise. Their contributions elevated the quality of my research substantially." },
    { id: 7, name: "Prakash Nimbekar", image: customerImg7, text: "I appreciate the personalized approach Quantive Research took with my project. They understood my specific needs and tailored their support accordingly." },
    ...
    { id: 10, name: "Abhishek Vaisakhi", image: customerImg10, text: "The literature review support from Quantive Research was exceptional. They helped me identify key gaps in existing research that became the foundation of my study." },
    { id: 11, name: "Sandipa Sharma", image: customerImg11, text: "Quantive Research's data analysis expertise helped me derive meaningful insights from complex datasets. Their statistical approach was both rigorous and innovative." },
    ...
    { id: 14, name: "Prabal Mukherjee", image: customerImg14, text: "Quantive Research delivered exceptional value with their comprehensive research support services. Their team's commitment to excellence is evident in every aspect of their work." },
    { id: 15, name: "Dr. Nazmul", image: customerImg15, text: "The research methodology guidance from Quantive Research helped me design a robust study that withstood peer review scrutiny. Their expertise in research design is truly remarkable." },
  ];
