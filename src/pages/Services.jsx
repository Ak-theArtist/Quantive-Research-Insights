    ...
    <div className="services-page">
      <div className="services-header">
        ...
        <div className="container">
          ...
          <p className="animate fade-up delay-200">Comprehensive research solutions tailored to your needs</p>
        </div>
      </div>

      <section className="services-intro">
        <div className="container">
          <div className="services-intro-content animate fade-up">
      ...
      <section className="service-categories">
        <div className="container">
          <div className="service-tabs animate fade-up">
            <button 
          ...
          <div className="service-content">
            {activeTab === 'academic' && (
              <div className="service-tab-content">
                <h3 className="animate fade-up">Academic Research Services</h3>
                ...
                <div className="services-grid">
                  ...
                  <div className="service-card animate fade-up delay-300">
                    <div className="service-icon">
                  ...
                  <div className="service-card animate fade-up delay-400">
                    <div className="service-icon">
            ...
            {activeTab === 'business' && (
              <div className="service-tab-content">
                <h3 className="animate fade-up">Business Research Services</h3>
                <p className="animate fade-up delay-100">
            ...
            {activeTab === 'publication' && (
              <div className="service-tab-content">
                <h3 className="animate fade-up">Publication Support Services</h3>
                <p className="animate fade-up delay-100">
      ...
      <section className="cta-section">
        <div className="container">
          <div className="cta-content animate fade-up">
            ...
            <p className="animate fade-up delay-100">Contact us today to discuss how we can support your research needs.</p>
            <Link to="/contact" className="btn btn-secondary animate scale delay-200">Get in Touch</Link>
          </div>
        </div>
      </section>
    </div>
